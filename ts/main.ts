...
const $hintBox = document.querySelector('.hint-box') as HTMLDialogElement;
const $hintsClose = document.querySelector('.hints-close') as HTMLButtonElement;
const $hintButton = document.querySelector('.hint-button') as HTMLButtonElement;
const $hintOpenButton1 = document.querySelector(
  '.hint-open-button1',
) as HTMLButtonElement;
const $hintOpenButton2 = document.querySelector(
  '.hint-open-button2',
) as HTMLButtonElement;
const $hintOpenButton3 = document.querySelector(
  '.hint-open-button3',
) as HTMLButtonElement;
const $hintOpenButton4 = document.querySelector(
  '.hint-open-button4',
) as HTMLButtonElement;
const $hintAnswer1Box = document.querySelector(
  '.hint-answer1-box',
) as HTMLDivElement;
const $hintAnswer2Box = document.querySelector(
  '.hint-answer2-box',
) as HTMLDivElement;
const $hintAnswer3Box = document.querySelector(
  '.hint-answer3-box',
) as HTMLDivElement;
const $hintAnswer4Box = document.querySelector(
  '.hint-answer4-box',
) as HTMLDivElement;
const $hint1Sprite = document.querySelector(
  '.hint-sprite-1',
) as HTMLImageElement;
const $hint2 = document.querySelector('.hint2') as HTMLDivElement;
const $hint4 = document.querySelector('.hint4') as HTMLDivElement;
const $hint3Sprite = document.querySelector(
  '.hint-sprite-3',
) as HTMLImageElement;
...
$hintBox.addEventListener('click', (event: Event) => {
  const eventTarget = event.target;
